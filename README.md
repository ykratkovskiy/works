"Report_manager" deletes "NOREAD" lanes from txt and csv files. This files we get from Lake Image machine vision after printing DataMatrix-codes on packaging films. 
